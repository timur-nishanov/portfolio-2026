/**
 * Brand glyphs for the footer spheres.
 *
 * Inline SVG rather than files: they inherit `currentColor`, so the same ink
 * token drives them as drove the labels they replace, and they cost no request.
 * Each is drawn on a 24×24 box so one size prop governs all three.
 */
